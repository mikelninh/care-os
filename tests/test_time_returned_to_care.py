...
def observation(*, participant="P01", condition=StudyCondition.BASELINE, seconds=3600, source_opens=4, accepted=0, missed=0, stops=()):
    return WorkflowObservation(
        participant_code=participant,
        workflow_id="physician-morning-review",
        role=StakeholderRole.PHYSICIAN,
        condition=condition,
        order_index=1 if condition == StudyCondition.BASELINE else 2,
...
def test_paired_report_requires_five_safe_pairs_before_highlighting_result():
    observations = []
